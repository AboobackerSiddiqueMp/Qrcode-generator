...
function Card() {
    ...
    return (
        <div className='card' style={{width:'400px',height:'400px',backgroundColor:'white',border:'1px solid #ccc', boxShadow:'0 0 10px rgba(0, 0, 0, 0.1)',borderRadius:'30px',alignContent:'center'}}>
            ...
            <input type="text" className='form-control w-50 mt-3' placeholder='plese enter the range' style={{margin:"blue", marginLeft:'102px'}} onChange={(e)=>{settext(e.target.value)}}/>
            <div>
